...
{	
	...
	{	
		$filter = "login = '$login'";
		$result = $this->msql->Select('users',$filter);
		return $result;
	}
	...
	public function GetUid()
	{
		...
		$t = "sid = '$sid'";
		$result = $this->msql->Select('sessions', $t);
	...
	private function GetSid()
	{
		...
		if ($sid != null)
		{
			...
			if ($affected_rows == 0)
			{
				...
				$query = sprintf($t, $sid);
				$result = $this->msql->justSelect($query);
	...
	private function OpenSession($id_user)
	{
		...
		$this->msql->Insert($session,'sessions');
